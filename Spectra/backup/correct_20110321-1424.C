void correct()
{
  ...
  h_real_tofw_pos_0_cent0088_pp->Divide(h_sim_tofw_pos_0_pp);
  h_real_tofw_neg_0_cent0088_pp->Divide(h_sim_tofw_neg_0_pp);
  h_real_tofw_pos_0_cent0088_mm->Divide(h_sim_tofw_pos_0_mm);
  h_real_tofw_neg_0_cent0088_mm->Divide(h_sim_tofw_neg_0_mm);
