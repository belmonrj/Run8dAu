...
void step1(int ipid=0, int itype=0, int iswitch=0)
{
...
void step2(int ipid=0, int itype=0, int iswitch=0)
{
  ...
  sprintf(name_real_tofw_pos_pp,"ptsys_%s_pos_%s%s",pidstring,typestring,switchstring);
  sprintf(name_sim_tofw_pos_pp,"ptsys_%s_pos_%s%s",pidstring,typestring,switchstring);
  sprintf(name_real_tofw_neg_pp,"ptsys_%s_neg_%s%s",pidstring,typestring,switchstring);
  sprintf(name_sim_tofw_neg_pp,"ptsys_%s_neg_%s%s",pidstring,typestring,switchstring);

  sprintf(name_real_tofw_pos_mm,"ptsys_%s_pos_%s%s",pidstring,typestring,switchstring);
  sprintf(name_sim_tofw_pos_mm,"ptsys_%s_pos_%s%s",pidstring,typestring,switchstring);
  sprintf(name_real_tofw_neg_mm,"ptsys_%s_neg_%s%s",pidstring,typestring,switchstring);
  ...
  sprintf(fnameoutpospm,"Data/ptsys_%s_pos_%s%s_pp.dat",pidstring,typestring,switchstring);
  sprintf(fnameoutnegpm,"Data/ptsys_%s_neg_%s%s_pp.dat",pidstring,typestring,switchstring);
  sprintf(fnameoutposmp,"Data/ptsys_%s_pos_%s%s_mm.dat",pidstring,typestring,switchstring);
  sprintf(fnameoutnegmp,"Data/ptsys_%s_neg_%s%s_mm.dat",pidstring,typestring,switchstring);
  ...
  */
  ...
  sprintf(fnameoutpospm,"Data/R5_ptsys_%s_pos_%s%s_pp.dat",pidstring,typestring,switchstring);
  sprintf(fnameoutnegpm,"Data/R5_ptsys_%s_neg_%s%s_pp.dat",pidstring,typestring,switchstring);
  sprintf(fnameoutposmp,"Data/R5_ptsys_%s_pos_%s%s_mm.dat",pidstring,typestring,switchstring);
  sprintf(fnameoutnegmp,"Data/R5_ptsys_%s_neg_%s%s_mm.dat",pidstring,typestring,switchstring);
  ...
  sprintf(fnameoutposcb,"Data/R5_ptsys_%s_pos_%s%s.dat",pidstring,typestring,switchstring);
  sprintf(fnameoutnegcb,"Data/R5_ptsys_%s_neg_%s%s.dat",pidstring,typestring,switchstring);
...
void step3(int ipid=0, int itype=0, int iswitch=0)
{
  ...
  sprintf(gifname,"UFig/single_spectra_%s_pos_%s%s.gif",pidstring,typestring,switchstring);
  sprintf(epsname,"UFig/single_spectra_%s_pos_%s%s.eps",pidstring,typestring,switchstring);
  c1->Print(gifname);
  c1->Print(epsname);
  ...
  sprintf(gifname,"UFig/single_spectra_%s_neg_%s%s.gif",pidstring,typestring,switchstring);
  sprintf(epsname,"UFig/single_spectra_%s_neg_%s%s.eps",pidstring,typestring,switchstring);
  c1->Print(gifname);
  c1->Print(epsname);
  ...
  sprintf(gifname,"UFig/single_ratio_%s_pos_%s%s.gif",pidstring,typestring,switchstring);
  sprintf(epsname,"UFig/single_ratio_%s_pos_%s%s.eps",pidstring,typestring,switchstring);
  c1->Print(gifname);
  c1->Print(epsname);
  ...
  sprintf(gifname,"UFig/single_suncert_%s_pos_%s%s.gif",pidstring,typestring,switchstring);
  sprintf(epsname,"UFig/single_suncert_%s_pos_%s%s.eps",pidstring,typestring,switchstring);
  c1->Print(gifname);
  c1->Print(epsname);
  ...
  sprintf(gifname,"UFig/single_ratio_%s_neg_%s%s.gif",pidstring,typestring,switchstring);
  sprintf(epsname,"UFig/single_ratio_%s_neg_%s%s.eps",pidstring,typestring,switchstring);
  c1->Print(gifname);
  c1->Print(epsname);
  ...
  sprintf(gifname,"UFig/single_suncert_%s_neg_%s%s.gif",pidstring,typestring,switchstring);
  sprintf(epsname,"UFig/single_suncert_%s_neg_%s%s.eps",pidstring,typestring,switchstring);
  c1->Print(gifname);
  c1->Print(epsname);
...
void step4(int ipid=0, int centid=0)
{
  ...
  char fignameA[100];
  sprintf(fignameA,"AFig/sys_uncert_pos_%s_sumA.png",pidstring);
  c1->Print(fignameA);
  sprintf(fignameA,"AFig/sys_uncert_pos_%s_sumA.eps",pidstring);
  c1->Print(fignameA);
  ...
  char fignameB[100];
  sprintf(fignameB,"AFig/sys_uncert_pos_%s_sumB.png",pidstring);
  c1->Print(fignameB);
  sprintf(fignameB,"AFig/sys_uncert_pos_%s_sumB.eps",pidstring);
  c1->Print(fignameB);
  ...
  char fignameAa[100];
  sprintf(fignameAa,"AFig/sys_uncert_pos_%s_sumAa.png",pidstring);
  c1->Print(fignameAa);
  sprintf(fignameAa,"AFig/sys_uncert_pos_%s_sumAa.eps",pidstring);
  c1->Print(fignameAa);
  ...
  char fignameBb[100];
  sprintf(fignameBb,"AFig/sys_uncert_pos_%s_sumBb.png",pidstring);
  c1->Print(fignameBb);
  sprintf(fignameBb,"AFig/sys_uncert_pos_%s_sumBb.eps",pidstring);
  c1->Print(fignameBb);
  ...
  char fignameA[100];
  sprintf(fignameA,"AFig/sys_uncert_neg_%s_sumA.png",pidstring);
  c1->Print(fignameA);
  sprintf(fignameA,"AFig/sys_uncert_neg_%s_sumA.eps",pidstring);
  c1->Print(fignameA);
  ...
  char fignameB[100];
  sprintf(fignameB,"AFig/sys_uncert_neg_%s_sumB.png",pidstring);
  c1->Print(fignameB);
  sprintf(fignameB,"AFig/sys_uncert_neg_%s_sumB.eps",pidstring);
  c1->Print(fignameB);
  ...
  char fignameAa[100];
  sprintf(fignameAa,"AFig/sys_uncert_neg_%s_sumAa.png",pidstring);
  c1->Print(fignameAa);
  sprintf(fignameAa,"AFig/sys_uncert_neg_%s_sumAa.eps",pidstring);
  c1->Print(fignameAa);
  ...
  char fignameBb[100];
  sprintf(fignameBb,"AFig/sys_uncert_neg_%s_sumBb.png",pidstring);
  c1->Print(fignameBb);
  sprintf(fignameBb,"AFig/sys_uncert_neg_%s_sumBb.eps",pidstring);
  c1->Print(fignameBb);
