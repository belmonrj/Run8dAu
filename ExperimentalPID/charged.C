void charged()
{
  ...
  hreal_pion_0->Add(hreal_kaon_0);
  hreal_pion_0->Add(hreal_proton_0);
  hreal_pion_1->Add(hreal_kaon_1);
  hreal_pion_1->Add(hreal_proton_1);
  hreal_pion_2->Add(hreal_kaon_2);
  hreal_pion_2->Add(hreal_proton_2);
  hreal_pion_3->Add(hreal_kaon_3);
  hreal_pion_3->Add(hreal_proton_3);
  hreal_pion_4->Add(hreal_kaon_4);
  hreal_pion_4->Add(hreal_proton_4);

  hreal_pion_5->SetLineColor(kBlack);
  ...
  leg->AddEntry(hreal_pion_5,"charged hadron","l");
  ...
  c1->Print("hadron_spectra.gif");
  c1->Print("hadron_spectra.eps");
  ...
  //hreal_pion_0->Divide(hreal_pion_5);
  hreal_pion_1->Divide(hreal_pion_5);
  hreal_pion_2->Divide(hreal_pion_5);
  hreal_pion_3->Divide(hreal_pion_5);
  hreal_pion_4->Divide(hreal_pion_5);
  ...
  //leg2->AddEntry(hreal_pion_5,"charged hadron","l");
  //leg2->AddEntry(hreal_pion_0,"0","l");
  leg2->AddEntry(hreal_pion_1,"1","l");
  leg2->AddEntry(hreal_pion_2,"2","l");
  leg2->AddEntry(hreal_pion_3,"3","l");
  leg2->AddEntry(hreal_pion_4,"4","l");
  //leg2->AddEntry(hreal_pion_5,"5","l");
  leg2->Draw();


  c1->Print("hadron_ratios.gif");
  c1->Print("hadron_ratios.eps");

  TH2F *hhh3 = new TH2F("hhh3","",1,0.0,5.0,1,0.8,1.2);
  hhh3->Draw();
  //hreal_pion_0->Draw("same");
  hreal_pion_1->Draw("same");
  hreal_pion_2->Draw("same");
  ...
  c1->Print("hadron_zratios.gif");
  c1->Print("hadron_zratios.eps");
