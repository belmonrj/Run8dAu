...
void doit_file(int centid=0, int pionid=0, int protonid=6)
{
  ...
  for(int i=0; i<12; i++)
      ...
      else
	{
	  ...
	  if(pionid==2) // THIS IS NEW
	    {
	      pionpos[i+24] *= epscale;
	      epionpos[i+24] *= epscale;
	    }
  ...
  for(int i=0; i<12; i++)
      ...
      else
	{
	  ...
	  if(pionid==2) // THIS IS NEW
	    {
	      pionneg[i+24] *= epscale;
	      epionneg[i+24] *= epscale;
	    }
	  if((float)pt[i+24]!=float(i)/2.0+0.25)
	    {
	      cout<<"you gonna die"<<endl;
  ...
  for(int i=0; i<12; i++)
      ...
      else
	{
	  ...
	  if(protonid==8) // THIS IS NEW
	    {
	      protonpos[i+24] *= epscale;
	      eprotonpos[i+24] *= epscale;
	    }
	  if((float)pt[i+24]!=float(i)/2.0+0.25)
	    {
	      cout<<"you gonna die"<<endl;
