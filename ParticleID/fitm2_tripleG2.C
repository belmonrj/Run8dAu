void fitm2_tripleG2()
{
  ...
  for(int i=0; i<40; i++)
      ...
      if(i>=30&&i<40)
	{
      ...
      superfun->SetParLimits(7,0.99*m2pr,1.05*m2pr);
      ...
      funkaonA->Draw("same");
      funprotA->Draw("same");
      sprintf(pionfigname,"m2pT_figs/m2pT_both_tripleG_method2_%d.gif",i);
      c1->Print(pionfigname);
      sprintf(pionfigname,"m2pT_figs/m2pT_both_tripleG_method2_%d.eps",i);
      c1->Print(pionfigname);
