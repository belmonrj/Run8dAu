void fitm2_pika3()
{
  ...
  for(int i=0; i<40; i++)
      ...
      if(i>=30&&i<40)
	{
      ...
      superfun->SetParLimits(2,0.9*funpion->GetParameter(2),1.1*funpion->GetParameter(2));
      ...
      superfun->SetParLimits(5,0.9*funkaon->GetParameter(2),1.1*funkaon->GetParameter(2));
      // funpion->Draw("same");
      // funkaon->Draw("same");
      // superfun->Draw("same");
      ...
      funpionA->Draw("same");
      funkaonA->Draw("same");
      sprintf(pionfigname,"m2pT_figs/m2pT_both_pionkaon_method3_%d.gif",i);
      c1->Print(pionfigname);
      sprintf(pionfigname,"m2pT_figs/m2pT_both_pionkaon_method3_%d.eps",i);
      c1->Print(pionfigname);
