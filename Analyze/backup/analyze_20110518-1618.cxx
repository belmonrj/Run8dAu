...
{ 
  ...
  TH2F *m2pTdis_pos         = new TH2F("m2pTdis_pos", "mom vs m2",  160, -8.0, 8.0, 300, -1.0, 2.0);
  TH2F *m2pTdis_neg         = new TH2F("m2pTdis_neg", "mom vs m2",  160, -8.0, 8.0, 300, -1.0, 2.0);
  TH2F *m2pTdis_pos_east    = new TH2F("m2pTdis_pos_east", "mom vs m2",  160, -8.0, 8.0, 300, -1.0, 2.0);
  TH2F *m2pTdis_neg_east    = new TH2F("m2pTdis_neg_east", "mom vs m2",  160, -8.0, 8.0, 300, -1.0, 2.0);
  ...
  //TH2F *m2pos_slat_dis      = new TH2F("m2pos_slat_dis", "m2 vs strip ",  512, 0, 511, 300, -1.0, 2.0);
  //TH2F *m2neg_slat_dis      = new TH2F("m2neg_slat_dis", "m2 vs strip ",  512, 0, 511, 300, -1.0, 2.0);
  //TH2F *m2pos_rune_dis      = new TH2F("m2pos_rune_dis", "m2 vs run ",  512, 0, 511, 300, -1.0, 2.0);
  //TH2F *m2neg_rune_dis      = new TH2F("m2neg_rune_dis", "m2 vs run ",  512, 0, 511, 300, -1.0, 2.0);
	  ...
	  for(int itrk=0; itrk<ktree->mNtrack; itrk++)
	    {
	      ...
	      //int striptofe   = (int)ktree->HadronTracks_striptofe[itrk];
	      //float tofeadcup = ktree->HadronTracks_tofeadcup[itrk];
	      //float tofeadcdw = ktree->HadronTracks_tofeadcdw[itrk];
	      ...
	      if(mom>1.1&&mom<1.5&&tfw_matching)
		{
	      ...
	      if(mom>1.1&&mom<1.5&&tfe_matching)
		{
		  etofdis->Fill(etof);
	      ...
	      if(charge>0)
		{
		  ...
		  m2pTdis_pos->Fill(pT,m2tofw);
		  m2pTdis_pos_east->Fill(pT,m2tofe);
		  ttofemompos_dis->Fill(mom,deltate);
	      ...
	      else
		{
		  ...
		  m2pTdis_neg->Fill(pT,m2tofw);
		  m2pTdis_neg_east->Fill(pT,m2tofe);
		  ttofemomneg_dis->Fill(mom,deltate);
	      ...
	      if(cent>60&&cent<=88)
		{
	      ...
	      // pid distributions
	      dis0 = isPi>=-2 && isPi<=2;
	      dis1 = isPi>=-2 && isPi<=2 && isK<=-2;
	      dis2 = isK>=-2 && isK<=2;
	      dis3 = isK>=-2 && isK<=2 && isPi>=2 && isP<=-2;
	      dis4 = isP>=-2 && isP<=2;
	      dis5 = isP>=-2 && isP<=2 && isK>=2;
