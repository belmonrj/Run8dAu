...
bool GoodInnerDCH(int run, float zed, float alpha, float phi)
{
  ...
  //if(alpha>22.3703*phi-22.3703*0.118409 && alpha>-21.3095*phi+21.3095*0.0383544 && alpha>0) return false; // checked, 
  ...
  if(zed<0)
    {
      ...
      // new A-shaped hole, lower alpha lower phi, egregious mismatch between sim and real requires large hole
