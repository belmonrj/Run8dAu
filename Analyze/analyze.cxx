      ...
      for(int i=0;i<n;i++) // loop over events
	{
	  ...
	  for(int itrk=0; itrk<ktree->mNtrack; itrk++)
	      ...
	      if(zed<0)
		{
		  ...
		  if(pT>0.55) hh_alphaphi_negzed_nc_FW->Fill(phi,alpha);
	      ...
	      if(westarm)
		{
		  ...
		  if(good_pc1) PC1ZedPhiDisWest_After->Fill(pc1z,pc1phi);
		  if(good_pc3&&pc3_matching) PC3ZedPhiDisWest_After->Fill(pc3z,pc3phi);
		}
	      ...
	      if(eastarm)
		{
		  ...
		  //if(sysgood_pc1) PC1ZedPhiDisEast_After->Fill(pc1z,pc1phi);
		  //if(sysgood_pc3&&pc3_matching) PC3ZedPhiDisEast_After->Fill(pc3z,pc3phi);
		  PC1ZedPhiDisEast_After->Fill(pc1z,pc1phi);
		  if(pc3_matching) PC3ZedPhiDisEast_After->Fill(pc3z,pc3phi);
		}
