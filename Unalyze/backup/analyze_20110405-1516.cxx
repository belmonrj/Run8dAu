...
bool GoodEdgeDCH(int run, float zed, float alpha, float phi)
{
  ...
  //if(alpha<slire*phi-slire*-0.191 && alpha>slire*phi-slire*-0.188) return false; // w1 wire // not straight
  //if(alpha<slire*phi-slire*0.006 && alpha>slire*phi-slire*0.009) return false; // w1 wire // leaving out for now
  ...
  if(zed>0)
    {
      ...
      if(alpha>22.3703*phi-22.3703*0.118409 && alpha>-21.3095*phi+21.3095*0.0383544 && alpha>0) return false; // checked // preferred for now
      ...
      // slope is 7.31094
      // 	y intercept is 1.34929
      // 	x intercept is -0.184557
      // 	alpha<>7.31094*phi-7.31094*-0.184557
  ...
  if(zed<0)
    {
      ...
      // triangular hole for lower alpha, lower phi
      //if(alpha<-17.3768*phi+17.3768*-0.191001 && alpha<18.8489*phi-18.8489*-0.200406) return false; // checked
      // triangular hole for lower alpha, lower phi, right side
      if(alpha<-17.3768*phi+17.3768*-0.191001 && alpha>-14.9259*phi+14.9259*-0.213603) return false; // a // checked
      // triangular hole for lower alpha, lower phi, left side
