void fit_doublegauss_sigmalized_zedmom_v2(
  ...
  for(int i=0; i<30; i++)
    {
      ...
      hhdz->Fit("fun","R");
      sprintf(figname,"DoubleGauss_SigmaliZedMom/figs/hh_%s_tofwsdz_%s_%s_%d.gif",sector,type,field,i);
      c1->Print(figname);
      foutdz<<mom<<"\t"
	    <<maximum<<"\t"
	    <<fun->GetParameter(1)<<"\t"
      ...
      hhdphi->Fit("fun","R");
      sprintf(figname,"DoubleGauss_SigmaliZedMom/figs/hh_%s_tofwsdphi_%s_%s_%d.gif",sector,type,field,i);
      c1->Print(figname);
      foutdphi<<mom<<"\t"
	      <<maximum<<"\t"
	      <<fun->GetParameter(1)<<"\t"
  ...
  for(int i=6; i<10; i++)
    {
      ...
      hhhdz->Fit("fun","R");
      sprintf(figname,"DoubleGauss_SigmaliZedMom/figs/hh_%s_tofwsdz_%s_%s_%d.gif",sector,type,field,j);
      c1->Print(figname);
      foutdz<<mom<<"\t"
	    <<maximum<<"\t"
	    <<fun->GetParameter(1)<<"\t"
      ...
      hhhdphi->Fit("fun","R");
      sprintf(figname,"DoubleGauss_SigmaliZedMom/figs/hh_%s_tofwsdphi_%s_%s_%d.gif",sector,type,field,j);
      c1->Print(figname);
      foutdphi<<mom<<"\t"
	      <<maximum<<"\t"
	      <<fun->GetParameter(1)<<"\t"
