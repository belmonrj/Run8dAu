void plot_doublegauss_sigmalized_zedmom_v5(
					   ...
					   )
{
  ...
  char filenamedz[80];
  sprintf(filenamedz,"DoubleGauss_SigmaliZedMom/hh_%s_tofwsdz_%s_%s.dat",sector,type,field);
  cout<<"name of tofwsdz input file is "<<filenamedz<<endl;

  char filenamedphi[80];
  sprintf(filenamedphi,"DoubleGauss_SigmaliZedMom/hh_%s_tofwsdphi_%s_%s.dat",sector,type,field);
  cout<<"name of tofwsdphi input file is "<<filenamedphi<<endl;

  // ---

  char figname_mean_dz_gif[80];
  sprintf(figname_mean_dz_gif,"DoubleGauss_SigmaliZedMom/hh_mean_%s_tofwsdz_%s_%s.gif",sector,type,field);
  cout<<"name of tofwsdz figure file is "<<figname_mean_dz_gif<<endl;

  char figname_mean_dphi_gif[80];
  sprintf(figname_mean_dphi_gif,"DoubleGauss_SigmaliZedMom/hh_mean_%s_tofwsdphi_%s_%s.gif",sector,type,field);
  cout<<"name of tofwsdphi figure file is "<<figname_mean_dphi_gif<<endl;

  char figname_mean_dz_eps[80];
  sprintf(figname_mean_dz_eps,"DoubleGauss_SigmaliZedMom/hh_mean_%s_tofwsdz_%s_%s.eps",sector,type,field);
  cout<<"name of tofwsdz figure file is "<<figname_mean_dz_eps<<endl;

  char figname_mean_dphi_eps[80];
  sprintf(figname_mean_dphi_eps,"DoubleGauss_SigmaliZedMom/hh_mean_%s_tofwsdphi_%s_%s.eps",sector,type,field);
  cout<<"name of tofwsdphi figure file is "<<figname_mean_dphi_eps<<endl;

  // ---

  char figname_sigma_dz_gif[80];
  sprintf(figname_sigma_dz_gif,"DoubleGauss_SigmaliZedMom/hh_sigma_%s_tofwsdz_%s_%s.gif",sector,type,field);
  cout<<"name of tofwsdz figure file is "<<figname_sigma_dz_gif<<endl;

  char figname_sigma_dphi_gif[80];
  sprintf(figname_sigma_dphi_gif,"DoubleGauss_SigmaliZedMom/hh_sigma_%s_tofwsdphi_%s_%s.gif",sector,type,field);
  cout<<"name of tofwsdphi figure file is "<<figname_sigma_dphi_gif<<endl;

  char figname_sigma_dz_eps[80];
  sprintf(figname_sigma_dz_eps,"DoubleGauss_SigmaliZedMom/hh_sigma_%s_tofwsdz_%s_%s.eps",sector,type,field);
  cout<<"name of tofwsdz figure file is "<<figname_sigma_dz_eps<<endl;

  char figname_sigma_dphi_eps[80];
  sprintf(figname_sigma_dphi_eps,"DoubleGauss_SigmaliZedMom/hh_sigma_%s_tofwsdphi_%s_%s.eps",sector,type,field);
  ...
  char fcodeoutdz[100];
  sprintf(fcodeoutdz,"DoubleGauss_SigmaliZedMom/parameters_hh_%s_tofwsdz_%s_%s.dat",sector,type,field);
  char fcodeoutdphi[100];
  sprintf(fcodeoutdphi,"DoubleGauss_SigmaliZedMom/parameters_hh_%s_tofwsdphi_%s_%s.dat",sector,type,field);
