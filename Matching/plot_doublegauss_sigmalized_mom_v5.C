void plot_doublegauss_sigmalized_mom_v5(
					   ...
					   )
{
  ...
  sprintf(figname_mean_dz_gif,"DoubleGauss_SigmaMom/hh_mean_%s_mom_tofwsdz_%s.gif",type,field);
  cout<<"name of tofwsdz figure file is "<<figname_mean_dz_gif<<endl;

  char figname_mean_dphi_gif[80];
  sprintf(figname_mean_dphi_gif,"DoubleGauss_SigmaMom/hh_mean_%s_mom_tofwsdphi_%s.gif",type,field);
  cout<<"name of tofwsdphi figure file is "<<figname_mean_dphi_gif<<endl;

  char figname_mean_dz_eps[80];
  sprintf(figname_mean_dz_eps,"DoubleGauss_SigmaMom/hh_mean_%s_mom_tofwsdz_%s.eps",type,field);
  cout<<"name of tofwsdz figure file is "<<figname_mean_dz_eps<<endl;

  char figname_mean_dphi_eps[80];
  sprintf(figname_mean_dphi_eps,"DoubleGauss_SigmaMom/hh_mean_%s_mom_tofwsdphi_%s.eps",type,field);
  cout<<"name of tofwsdphi figure file is "<<figname_mean_dphi_eps<<endl;

  // ---

  char figname_sigma_dz_gif[80];
  sprintf(figname_sigma_dz_gif,"DoubleGauss_SigmaMom/hh_sigma_%s_mom_tofwsdz_%s.gif",type,field);
  cout<<"name of tofwsdz figure file is "<<figname_sigma_dz_gif<<endl;

  char figname_sigma_dphi_gif[80];
  sprintf(figname_sigma_dphi_gif,"DoubleGauss_SigmaMom/hh_sigma_%s_mom_tofwsdphi_%s.gif",type,field);
  cout<<"name of tofwsdphi figure file is "<<figname_sigma_dphi_gif<<endl;

  char figname_sigma_dz_eps[80];
  sprintf(figname_sigma_dz_eps,"DoubleGauss_SigmaMom/hh_sigma_%s_mom_tofwsdz_%s.eps",type,field);
  cout<<"name of tofwsdz figure file is "<<figname_sigma_dz_eps<<endl;

  char figname_sigma_dphi_eps[80];
  sprintf(figname_sigma_dphi_eps,"DoubleGauss_SigmaMom/hh_sigma_%s_mom_tofwsdphi_%s.eps",type,field);
  ...
  char fcodeoutdz[100];
  sprintf(fcodeoutdz,"DoubleGauss_SigmaMom/parameters_hh_%s_mom_tofwsdz_%s.dat",type,field);
  char fcodeoutdphi[100];
  sprintf(fcodeoutdphi,"DoubleGauss_SigmaMom/parameters_hh_%s_mom_tofwsdphi_%s.dat",type,field);
