void plot_sigmalized_zedmom_v5(
			       ...
			       )
{
  ...
  TF1 *funmeandz = new TF1("funmeandz","[0]+[1]/x+[2]/x/x+[3]/sqrt(x)",0.3,5.0);
  funmeandz->SetLineColor(kRed);
  TF1 *funmeandphi = new TF1("funmeandphi","[0]+[1]/x+[2]/x/x+[3]/sqrt(x)",0.3,5.0);
  ...
  TF1 *funsigmadz = new TF1("funsigmadz","[0]+[1]/x+[2]/x/x+[3]/sqrt(x)",0.3,5.0);
  funsigmadz->SetLineColor(kRed);
  TF1 *funsigmadphi = new TF1("funsigmadphi","[0]+[1]/x+[2]/x/x+[3]/sqrt(x)",0.3,5.0);
