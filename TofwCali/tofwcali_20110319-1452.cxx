...
{ 
  ...
  TH1F *htofwsdz = new TH1F("htofwsdz","htofwdz",200, -10,10);
  TH1F *htofwsdphi = new TH1F("htofwsdphi","htofwdphi",200, 10,10);
  ...
  // no cuts
  // zed>0
  TH2F *hh_alphaphiX_poszed_nc = new TH2F("hh_alphaphiX_poszed_nc","alpha vs phi zed>0 no cuts", 1500, -0.5, 1.0, 1200, -0.6, 0.6);
  // zed<0
  TH2F *hh_alphaphiX_negzed_nc = new TH2F("hh_alphaphiX_negzed_nc","alpha vs phi zed<0 no cuts", 1500, -0.5, 1.0, 1200, -0.6, 0.6);

  // matching cuts
  // zed>0
  TH2F *hh_alphaphiX_poszed_mc = new TH2F("hh_alphaphiX_poszed_mc","alpha vs phi zed>0 matching cuts", 1500, -0.5, 1.0, 1200, -0.6, 0.6);
  // zed<0
  TH2F *hh_alphaphiX_negzed_mc = new TH2F("hh_alphaphiX_negzed_mc","alpha vs phi zed<0 matching cuts", 1500, -0.5, 1.0, 1200, -0.6, 0.6);

  // all cuts
  // zed>0
  TH2F *hh_alphaphiX_poszed_ac = new TH2F("hh_alphaphiX_poszed_ac","alpha vs phi zed>0 all cuts", 1500, -0.5, 1.0, 1200, -0.6, 0.6);
  // zed<0
  TH2F *hh_alphaphiX_negzed_ac = new TH2F("hh_alphaphiX_negzed_ac","alpha vs phi zed<0 all cuts", 1500, -0.5, 1.0, 1200, -0.6, 0.6);
      ...
      for(int i=0;i<n;i++) // loop over events
	{
	  ...
	  for(int itrk=0; itrk<ktree->mNtrack; itrk++)
	      ...
	      if(charge<0&&striptofw>255)
		{
	      ...
	      if(fabs(tofwsdphi)<3.0) htofwsdz->Fill(tofwsdz);
	      if(fabs(tofwsdz)<3.0)   htofwsdphi->Fill(tofwsdphi);
	
	      if(fabs(tofwsdphi)<3.0) hh_strip_tofwsdz->Fill(striptofw,tofwsdz);
	      if(fabs(tofwsdz)<3.0)   hh_strip_tofwsdphi->Fill(striptofw,tofwsdphi);
	      if(fabs(tofwsdphi)<3.0) hh_cent_tofwsdz->Fill(cent,tofwsdz);
	      if(fabs(tofwsdz)<3.0)   hh_cent_tofwsdphi->Fill(cent,tofwsdphi);
	      if(fabs(tofwsdphi)<3.0) hh_mom_tofwsdz->Fill(mom,tofwsdz);
	      if(fabs(tofwsdz)<3.0)   hh_mom_tofwsdphi->Fill(mom,tofwsdphi);
	      if(fabs(tofwsdphi)<3.0) hh_zed_tofwsdz->Fill(zed,tofwsdz);
	      if(fabs(tofwsdz)<3.0)   hh_zed_tofwsdphi->Fill(zed,tofwsdphi);

	      if(charge>0)
		{
		  if(fabs(tofwsdphi)<3.0) hh_pos_strip_tofwsdz->Fill(striptofw,tofwsdz);
		  if(fabs(tofwsdz)<3.0)   hh_pos_strip_tofwsdphi->Fill(striptofw,tofwsdphi);
		  if(fabs(tofwsdphi)<3.0) hh_pos_cent_tofwsdz->Fill(cent,tofwsdz);
		  if(fabs(tofwsdz)<3.0)   hh_pos_cent_tofwsdphi->Fill(cent,tofwsdphi);
		  if(fabs(tofwsdphi)<3.0) hh_pos_mom_tofwsdz->Fill(mom,tofwsdz);
		  if(fabs(tofwsdz)<3.0)   hh_pos_mom_tofwsdphi->Fill(mom,tofwsdphi);
		  if(fabs(tofwsdphi)<3.0) hh_pos_zed_tofwsdz->Fill(zed,tofwsdz);
		  if(fabs(tofwsdz)<3.0)   hh_pos_zed_tofwsdphi->Fill(zed,tofwsdphi);
		}

	      if(charge<0)
		{
		  if(fabs(tofwsdphi)<3.0) hh_neg_strip_tofwsdz->Fill(striptofw,tofwsdz);
		  if(fabs(tofwsdz)<3.0)   hh_neg_strip_tofwsdphi->Fill(striptofw,tofwsdphi);
		  if(fabs(tofwsdphi)<3.0) hh_neg_cent_tofwsdz->Fill(cent,tofwsdz);
		  if(fabs(tofwsdz)<3.0)   hh_neg_cent_tofwsdphi->Fill(cent,tofwsdphi);
		  if(fabs(tofwsdphi)<3.0) hh_neg_mom_tofwsdz->Fill(mom,tofwsdz);
		  if(fabs(tofwsdz)<3.0)   hh_neg_mom_tofwsdphi->Fill(mom,tofwsdphi);
		  if(fabs(tofwsdphi)<3.0) hh_neg_zed_tofwsdz->Fill(zed,tofwsdz);
		  if(fabs(tofwsdz)<3.0)   hh_neg_zed_tofwsdphi->Fill(zed,tofwsdphi);
		}
	      ...
	      if(charge>0&&striptofw<256)
		{
		  if(zed>0&&zed<15)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_posmom_poszed0->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_posmom_poszed0->Fill(mom,tofwsdphi);
		    }
		  if(zed>15&&zed<30)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_posmom_poszed1->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_posmom_poszed1->Fill(mom,tofwsdphi);
		    }
		  if(zed>30&&zed<45)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_posmom_poszed2->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_posmom_poszed2->Fill(mom,tofwsdphi);
		    }
		  if(zed>45&&zed<60)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_posmom_poszed3->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_posmom_poszed3->Fill(mom,tofwsdphi);
		    }
		  if(zed>60&&zed<75)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_posmom_poszed4->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_posmom_poszed4->Fill(mom,tofwsdphi);
		    }
		  if(zed<0&&zed>-15)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_posmom_negzed0->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_posmom_negzed0->Fill(mom,tofwsdphi);
		    }
		  if(zed<-15&&zed>-30)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_posmom_negzed1->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_posmom_negzed1->Fill(mom,tofwsdphi);
		    }
		  if(zed<-30&&zed>-45)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_posmom_negzed2->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_posmom_negzed2->Fill(mom,tofwsdphi);
		    }
		  if(zed<-45&&zed>-60)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_posmom_negzed3->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_posmom_negzed3->Fill(mom,tofwsdphi);
		    }
		  if(zed<-60&&zed>-75)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_posmom_negzed4->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_posmom_negzed4->Fill(mom,tofwsdphi);
		    }
		}
	      if(charge<0&&striptofw<256)
		{
		  if(zed>0&&zed<15)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_negmom_poszed0->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_negmom_poszed0->Fill(mom,tofwsdphi);
		    }
		  if(zed>15&&zed<30)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_negmom_poszed1->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_negmom_poszed1->Fill(mom,tofwsdphi);
		    }
		  if(zed>30&&zed<45)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_negmom_poszed2->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_negmom_poszed2->Fill(mom,tofwsdphi);
		    }
		  if(zed>45&&zed<60)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_negmom_poszed3->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_negmom_poszed3->Fill(mom,tofwsdphi);
		    }
		  if(zed>60&&zed<75)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_negmom_poszed4->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_negmom_poszed4->Fill(mom,tofwsdphi);
		    }
		  if(zed<0&&zed>-15)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_negmom_negzed0->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_negmom_negzed0->Fill(mom,tofwsdphi);
		    }
		  if(zed<-15&&zed>-30)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_negmom_negzed1->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_negmom_negzed1->Fill(mom,tofwsdphi);
		    }
		  if(zed<-30&&zed>-45)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_negmom_negzed2->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_negmom_negzed2->Fill(mom,tofwsdphi);
		    }
		  if(zed<-45&&zed>-60)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_negmom_negzed3->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_negmom_negzed3->Fill(mom,tofwsdphi);
		    }
		  if(zed<-60&&zed>-75)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector1_tofwsdz_negmom_negzed4->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector1_tofwsdphi_negmom_negzed4->Fill(mom,tofwsdphi);
		    }
		}
	      ...
	      if(charge>0&&striptofw>255)
		{
		  if(zed>0&&zed<15)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_posmom_poszed0->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_posmom_poszed0->Fill(mom,tofwsdphi);
		    }
		  if(zed>15&&zed<30)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_posmom_poszed1->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_posmom_poszed1->Fill(mom,tofwsdphi);
		    }
		  if(zed>30&&zed<45)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_posmom_poszed2->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_posmom_poszed2->Fill(mom,tofwsdphi);
		    }
		  if(zed>45&&zed<60)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_posmom_poszed3->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_posmom_poszed3->Fill(mom,tofwsdphi);
		    }
		  if(zed>60&&zed<75)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_posmom_poszed4->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_posmom_poszed4->Fill(mom,tofwsdphi);
		    }
		  if(zed<0&&zed>-15)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_posmom_negzed0->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_posmom_negzed0->Fill(mom,tofwsdphi);
		    }
		  if(zed<-15&&zed>-30)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_posmom_negzed1->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_posmom_negzed1->Fill(mom,tofwsdphi);
		    }
		  if(zed<-30&&zed>-45)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_posmom_negzed2->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_posmom_negzed2->Fill(mom,tofwsdphi);
		    }
		  if(zed<-45&&zed>-60)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_posmom_negzed3->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_posmom_negzed3->Fill(mom,tofwsdphi);
		    }
		  if(zed<-60&&zed>-75)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_posmom_negzed4->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_posmom_negzed4->Fill(mom,tofwsdphi);
		    }
		}
	      if(charge<0&&striptofw>255)
		{
		  if(zed>0&&zed<15)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_negmom_poszed0->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_negmom_poszed0->Fill(mom,tofwsdphi);
		    }
		  if(zed>15&&zed<30)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_negmom_poszed1->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_negmom_poszed1->Fill(mom,tofwsdphi);
		    }
		  if(zed>30&&zed<45)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_negmom_poszed2->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_negmom_poszed2->Fill(mom,tofwsdphi);
		    }
		  if(zed>45&&zed<60)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_negmom_poszed3->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_negmom_poszed3->Fill(mom,tofwsdphi);
		    }
		  if(zed>60&&zed<75)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_negmom_poszed4->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_negmom_poszed4->Fill(mom,tofwsdphi);
		    }
		  if(zed<0&&zed>-15)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_negmom_negzed0->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_negmom_negzed0->Fill(mom,tofwsdphi);
		    }
		  if(zed<-15&&zed>-30)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_negmom_negzed1->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_negmom_negzed1->Fill(mom,tofwsdphi);
		    }
		  if(zed<-30&&zed>-45)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_negmom_negzed2->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_negmom_negzed2->Fill(mom,tofwsdphi);
		    }
		  if(zed<-45&&zed>-60)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_negmom_negzed3->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_negmom_negzed3->Fill(mom,tofwsdphi);
		    }
		  if(zed<-60&&zed>-75)
		    {
		      if(fabs(tofwsdphi)<3.0) hh_sector2_tofwsdz_negmom_negzed4->Fill(mom,tofwsdz);
		      if(fabs(tofwsdz)<3.0)   hh_sector2_tofwsdphi_negmom_negzed4->Fill(mom,tofwsdphi);
		    }
		}
